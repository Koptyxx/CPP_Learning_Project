...
-avantage : un code plus lisible, respect du single responsibility principle

-désavantage : plus long à implémenter

Choix 2 :

-avantage : 

-avantage : plus facile à implémenter, pas la peine de créer des nouvelles instances d'objets

-désavantage : un code lourd pour une seule et même classe, non-respect du single responsibility principle
...
####Réponse : 
Les avions étant représenté par la classe aircraft, le destructeur de cette classe est responsable de la suppression de ceux-ci.

2. Quelles autres structures contiennent une référence sur un avion au moment où il doit être détruit ?

####Réponse :
Les structures contenant une référence sur un avion au moment où il doit être détruit sont :

- la move_queue stockant les avions
- la fonction move servant à faire bouger les avions

3. Comment fait-on pour supprimer la référence sur un avion qui va être détruit dans ces structures ?

####Réponse :

En faisant appelle aux destructeurs afin de pouvoir supprimer la référence en question.
