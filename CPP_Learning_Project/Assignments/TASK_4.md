...
En appellant la fonction, on rajoute entre chevron false comme suit : add_waypoint<false>(wp)
...
Nous avons ici des erreurs de typages.  
Cela ne se produit que maintenant car nous avons changé notre implémentation qui représente les points.
